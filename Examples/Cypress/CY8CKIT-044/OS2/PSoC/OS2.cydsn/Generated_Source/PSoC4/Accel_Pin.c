...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Accel_Pin_PC =   (Accel_Pin_PC & \
                                (uint32)(~(uint32)(Accel_Pin_DRIVE_MODE_IND_MASK << (Accel_Pin_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Accel_Pin_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  Accel_Pin_DM_STRONG     Strong Drive 
*  Accel_Pin_DM_OD_HI      Open Drain, Drives High 
*  Accel_Pin_DM_OD_LO      Open Drain, Drives Low 
*  Accel_Pin_DM_RES_UP     Resistive Pull Up 
*  Accel_Pin_DM_RES_DWN    Resistive Pull Down 
*  Accel_Pin_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Accel_Pin_DM_DIG_HIZ    High Impedance Digital 
*  Accel_Pin_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(Accel_Pin__0__SHIFT, mode);
}
...
*  
* Note:
*  Macro Accel_Pin_ReadPS calls this function. 
*  
*******************************************************************************/
