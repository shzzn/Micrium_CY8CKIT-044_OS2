...
*   Values:
*     - PWM_Blue_CMD_CAPTURE    - Trigger Capture command
*     - PWM_Blue_CMD_RELOAD     - Trigger Reload command
*     - PWM_Blue_CMD_STOP       - Trigger Stop command
*     - PWM_Blue_CMD_START      - Trigger Start command
*
* Return:
*  None
*
